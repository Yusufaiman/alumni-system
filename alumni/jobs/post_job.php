<?php
/**
 * POST NEW JOB FORM (ALUMNI)
 * Allows alumni to share job openings with students.
 * Fix: Removed companyName (incorrect) and used company (correct), with robust error handling.
 */
session_start();
...
<head>
    ...
    <title>Post New Job | Alumni Connect</title>
    <!-- Google Fonts -->
...
<body>
    ...
    <div class="jobs-container">
        ...
        <header class="jobs-header" style="text-align: center; margin-bottom: 3rem;">
            <h1>Post New Job</h1>
            <p>Fill in the details below to share a new career opportunity with our students.</p>
        </header>
